"""
Django settings for testapp5_7 project.
...
WSGI_APPLICATION = 'testapp5_7.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapp5_7 API",
    "DESCRIPTION": "API documentation for testapp5_7 App",
    "VERSION": "v1",
}
